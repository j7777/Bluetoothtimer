...
public class TimerActivityClient1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(TimerActivityClient1.this, "Ошибка установки настроек!", Toast.LENGTH_LONG).show();
        }

        try {
            enable_bt_adapter_flag = getIntent().getExtras().getBoolean("enable_bt_adapter_flag");
        } catch (Exception e) {
            Toast.makeText(TimerActivityClient1.this, "Ошибка данных!", Toast.LENGTH_LONG).show();
        }
            ...
            public void onClick(View v) {
                ...
                if(checkColorDisabled()) {
                    ...
                    if(sendCommand(String.valueOf(jsonObject))){
                        ...
                        onStartTimer();
                        my_time_end_text.setTextColor(ContextCompat.getColor(TimerActivityClient1.this, R.color.my_time_start_color));
                    }
                }
            }
        });
        ...
        fab5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                menuLabels.toggle(true);
                Intent intent = new Intent(TimerActivityClient1.this, SettingsActivity.class);
        ...
        snackBarBack.setAction(R.string.dialog_confirm_close_ok, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TimerActivityClient1.this, MainActivity.class);
    ...
    private void setupTimer() {
        ...
        mTimerService = new TimerService(TimerActivityClient1.this, mHandler);
            ...
            switch (msg.what) {
                ...
                case MESSAGE_READ:
                    ...
                    if(userTimeEnd){
                        ...
                        TextView textView = (TextView)view .findViewById(android.support.design.R.id.snackbar_text);
                        snack.show();
                        my_time_end_text.setTextColor(ContextCompat.getColor(TimerActivityClient1.this, R.color.my_time_end_color));
                    }
    ...
    private Boolean sendCommand(String message){
        if (mTimerService.getState() != TimerService.STATE_CONNECTED) {
            return false;
        }
